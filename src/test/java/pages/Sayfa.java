...
public class Sayfa {
    ...
    public void alanaYaziYaz(String elementId, String emailAdres) {
    ...
    public void klavyeTusunaBas(String elementId, Keys klavyeTus) {
        driver.findElement(By.cssSelector(elementId)).sendKeys(klavyeTus);
    }
}
